...
public class TouristServicePhotoCollectionDAO {
    ...
    private final static String addPhotoQuery="insert into tourist_service_photo_collection values (?,?)";
	
    private final static String getPhotoQuery="select * from tourist_service_photo_collection where photo_collection_id = ? ";
